...
*****************************************************************************************
Python & other object oriented programming languages has revolutionized programing 
Here are four ways that we can accomplish prerocessing task in python libraries.

Data Inspection - Useful Function: 
--> data.shape
--> dat.info()
--> data.describe()
--> data.head()
...
############################ Using Using CategoryEncoders (category_encoders)############
import pandas as pd
